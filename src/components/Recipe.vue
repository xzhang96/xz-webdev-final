        ...
        <v-card v-if="recipe !== null">
            <v-row>
                <v-col cols="3">
                    ...
                    >
                        <v-img :src="recipe.image" width="100%"> </v-img>
                        <v-list dense>
                            <v-list-item>
                                <v-btn
                ...
                <v-col cols="9">
                    ...
                    <div class="content">
                        ...
                        <br />
                        <v-list
                            v-if="this.recipe.analyzedInstructions.length !== 0"
                        >
                            <template
...
export default {
    ...
    mounted: async function () {
        try {
            const response = await SearchService.getRecipe(
                this.$route.query.id
            );

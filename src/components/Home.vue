        ...
        <v-tabs-items v-model="tab">
            <v-tab-item>
                ...
                <v-card class="mx-auto" width="70%">
                    ...
                    <v-card-actions class="action">
                        <v-btn @click="submitSearchItem"> Search </v-btn>
                        <v-btn @click="clearSearchItem"> Clear </v-btn>
                        <br />
                        <br />
                        <br />
                        <br />
            ...
            <v-tab-item>
                ...
                <v-card class="mx-auto" width="70%">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <strong>{{ item }}</strong
                                    >&nbsp;
                                    <span v-if="pantryItems.includes(item)"
                                        >(From pantry)</span
                                    >
                                </v-chip>
                            </template>
                    ...
                    <v-card-actions class="action">
                        <v-btn @click="submitSearchIngredients"> Search </v-btn>
                        <v-btn @click="clearSearchIngredients"> Clear </v-btn>
                        <br />
                        <br />
                        <br />
                        <br />
